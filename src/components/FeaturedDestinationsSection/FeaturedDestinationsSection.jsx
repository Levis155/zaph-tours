...
function FeaturedDestinationsSection() {
  return (
    <section>
      <Title
        titleSub={"featured destinations"}
        titleMain={"discover our top picks"}
      />

      <div className="destination-cards">
        {featuredDestData.map((destData) => (
          <DestinationCard
            key={destData.destinationName}
            Image={destData.image}
            DestinationName={destData.destinationName}
            DestinationExcerpt={destData.destinationExcerpt}
            DestinationPrice={destData.destinationPrice}
          />
        ))}
      </div>
    </section>
