...
function DestinationsPageTitle() {
    return(
        <div className='destination-page-title'>
            ...
            <p className="destination-page-title-main">Discover the World, One Adventure at a Time</p>
        </div>
    )
}
...
function DPCards() {
    return (
        <>
            ...
            {
                destinationsData.map(data => <DPCard key={data.name} Img={data.img} Name={data.name} Tagline={data.tagline} Excerpt={data.excerpt} PriceGroup={data.priceGroup} PriceIndividual={data.priceIndividual} />)
            }
        </>
    )
}
    ...
    return(
        <div className="dp-card">
            <div className="dp-card-image-wrapper">
                ...
                <div className="dp-card-image-name"><p>{Name}</p></div>
